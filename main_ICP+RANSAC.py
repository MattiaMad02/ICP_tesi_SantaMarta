...
for idx, src_file in enumerate(source_files, start=1):
    ...
    reg_icp = o3d.pipelines.registration.registration_icp(
        src_pcd, target_pcd, icp_threshold, np.eye(4),
    ...
    summary_lines.append(f"Frame {idx}: RANSAC Fitness={result_ransac.fitness:.4f}, ICP Fitness={reg_icp.fitness:.4f}, RMSE={reg_icp.inlier_rmse:.4f}\n")
