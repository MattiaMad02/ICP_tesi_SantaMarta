...
map_no_icp_path = os.path.join(base_folder, "ransac_results", "merged_ransac_map.ply")  # mappa ransac
...
# Colora la mapps RANSAC in rosso, quella ICP in verde
map_no_icp.paint_uniform_color([1, 0, 0])  # rosso
map_icp.paint_uniform_color([0, 1, 0])    # verde

print("\n Visualizzazione: ROSSO = RANSAC | VERDE = ICP")
