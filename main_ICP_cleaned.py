...
save_folder = os.path.join(project_folder, "icp_cleaned_results")
...
point_clouds = [preprocess_frame(o3d.io.read_point_cloud(f), voxel_size, nb_neighbors, std_ratio)
                for f in source_files]
transformations = []
summary_lines = []
print("\nAvvio ICP con pulizia outlier...\n")
...
map_pcd_cleaned, _ = map_pcd.remove_statistical_outlier(nb_neighbors=nb_neighbors, std_ratio=std_ratio)
